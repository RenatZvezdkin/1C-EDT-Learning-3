Процедура ОбработкаПроведения(Отказ,Режим)
	...
	Если не Отказ тогда
			...
			Пока ВыборкаДетальныеЗаписи.Следующий() Цикл
				...
				Движение.Период = Дата;
				Движение.ВидДвижения = ВидДвиженияНакопления.Расход;
				Движение.Количество = Товары.Найти(ВыборкаДетальныеЗаписи.Товар, "Товар").Количество;
				Движение.Сумма = Товары.Найти(ВыборкаДетальныеЗаписи.Товар, "Товар").Количество*Себестоимость;
